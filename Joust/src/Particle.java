...
public class Particle {
	...
	public void bounceIfOutsideOf(Rectangle r, double bounciness)
	{
		...
		if (this.x > r.getWidth() + r.getX())
		{
			this.x = r.getWidth() + r.getX();
			this.vx = -Math.abs(this.vx*bounciness);
		}
		if (this.y < r.getY())
		{
		...
		if (this.y > r.getHeight() + r.getY())
		{
			this.y = r.getHeight() + r.getY();
			this.vy = -Math.abs(this.vy*bounciness);
		}
	}
	
	public void bounceY(Rectangle r, double bounciness)
	{
		if (this.y < r.getY())
		{
			this.y = r.getY() - 25;
	...
	public void bounceX(Rectangle r, double bounciness)
	{
		if (this.x < r.getX())
		{
			this.x = r.getX() - 25;
...
//		{
//			this.y = r.getY() - 25;
//			this.vy = -3000;//-Math.abs(this.vy*bounciness);
//		}
//		if (this.y < r.getY())
//		{
//			this.y = r.getHeight() + r.getY();
...
//		}
	...
	public void bounce(Rectangle r, double bounciness)
	{
		if (this.x > r.getX())
		{
			this.x = r.getX() + this.x;
			this.vx = Math.abs(this.vx*bounciness);
		}
		if (this.x < r.getWidth() + r.getX())
		{
